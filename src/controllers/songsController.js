...
export default {
    ...
    async create(req, res) {
        ...
        return res.status(201).send({ data: song, message: `Piosenka została dodana.` });
    },
    ...
    async update(req, res, next) {
        ...
        return res.status(200).send({ data: song, message: `Piosenka została zaktualizowana` });
    },
    ...
    async remove(req, res, next) {
        ...
        return res.status(200).send({ message: `Piosenka została usunięta.` });
    }
}